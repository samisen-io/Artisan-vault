              ...
              <b-card-body>
                ...
                <b-row>
                  ...
                  <b-col col md="6">
                    <br />
                    <a
                      :href="drawing.facebookPageUrl" target="_blank"
                    >
                      <h3>@{{drawing.artistName}}</h3></a
                    >
                  </b-col>
                </b-row>
                ...
                <b-card-text>
                  <br />
                  <h1><p class="font-weight-bold">{{drawing.artistName}}</p></h1>
                </b-card-text>
                <b-card-text>
                  <br />
                  <h4>PhotoPrice</h4>
                  <h3>{{drawing.price}} Rs</h3>
                </b-card-text>
                <b-card-text>
                  <br />
   ...
   computed: {
    drawing() {
      ...
      artworkObj = this.$store.state.highlightedCards.find((obj) =>
        obj.type.toLowerCase().includes("drawing")
      );
      return artworkObj;
    },
  },
